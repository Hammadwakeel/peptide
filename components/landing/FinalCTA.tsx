    ...
    <section className="bg-pure-white py-32 lg:py-40">
      <div className="mx-auto max-w-[1400px] px-8 md:px-12 lg:px-20">
        ...
        <div className="text-center">
          ...
          <h2 className="mx-auto mt-6 max-w-5xl font-serif text-5xl font-light leading-[1.02] tracking-[-0.04em] text-deep-teal md:text-6xl lg:text-8xl">
            Ready to verify
            <br />
            the future?
          </h2>

          <p className="mx-auto mt-8 max-w-2xl text-lg leading-relaxed text-deep-teal/70 lg:text-xl">
            Join the network of practitioners, pharmacies, and clinical
            teams who refuse to compromise on molecular certainty.
          </p>
