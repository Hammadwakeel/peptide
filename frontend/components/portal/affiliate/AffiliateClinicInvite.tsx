  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center gap-4 rounded-2xl border border-deep-teal/20 bg-pure-white px-4 py-2.5 shadow-[0_2px_12px_rgba(1,26,36,0.08)] sm:px-5">
        <h1 className="shrink-0 font-sans text-xl font-light text-deep-teal sm:text-2xl">Invite Clinic</h1>
          ...
          {isLoading ? (
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="rounded-xl border border-deep-teal/10 bg-surface-muted/40 px-3 py-2.5">
                <p className="text-[10px] font-light uppercase tracking-wide text-deep-teal/45">Referral code</p>
                <p className="mt-1 font-sans text-sm font-light text-deep-teal">{referralCode}</p>
              </div>
