...
export function WmsDashboard() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="font-sans text-2xl font-light text-deep-teal">WMS Dashboard</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <div className="rounded-2xl border border-deep-teal/10 bg-pure-white px-4 py-5 shadow-sm">
          ...
          <p className="mt-2 font-sans text-3xl font-light text-deep-teal">{metrics.pendingShipments}</p>
        ...
        <div className="rounded-2xl border border-deep-teal/10 bg-pure-white px-4 py-5 shadow-sm">
          ...
          <p className="mt-2 font-sans text-3xl font-light text-deep-teal">{metrics.avgDaysToShip}</p>
        </div>
        <div className="rounded-2xl border border-deep-teal/10 bg-pure-white px-4 py-5 shadow-sm">
          <p className="text-xs uppercase tracking-wide text-deep-teal/45">Late Orders</p>
          <p className="mt-2 font-sans text-3xl font-light text-coral-blush">{metrics.lateOrders}</p>
        </div>
        <div className="rounded-2xl border border-deep-teal/10 bg-pure-white px-4 py-5 shadow-sm">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        {[
          ...
          >
            <p className="font-light text-deep-teal">{item.label}</p>
