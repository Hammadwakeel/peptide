  ...
  if (!token) {
    return (
      <div className="flex min-h-dvh items-center justify-center bg-pure-white px-4">
        <AuthCard>
          <h1 className="font-serif text-2xl font-light text-deep-teal">Invalid activation link</h1>
    ...
    return (
      <div className="flex min-h-dvh items-center justify-center bg-pure-white px-4">
        <AuthCard>
          ...
          <h1 className="font-serif text-2xl font-light text-deep-teal">You&apos;re all set</h1>
    ...
    <div className="flex min-h-dvh flex-col bg-pure-white lg:flex-row">
        ...
        <div>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-deep-teal/55">{tagline}</p>
            </div>
          </div>
      ...
      <div className="flex flex-1 items-center justify-center px-4 py-10 sm:px-8">
        <div className="w-full max-w-md">
          ...
          <h2 className="mt-2 font-serif text-2xl font-light text-deep-teal">Create your password</h2>
