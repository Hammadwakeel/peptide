...
export function LoginPageSkeleton() {
  return (
    <div
      className="flex h-full bg-pure-white"
      aria-busy="true"
      aria-label="Loading sign in page"
    >
      <Skeleton className="hidden h-full w-1/2 rounded-none lg:block" />

      <div className="flex h-full w-full flex-col px-6 py-6 lg:w-1/2 lg:px-12 xl:px-16">
